#!/usr/bin/env python3
"""Train/export a weighted-mix C2H4 case-pair FNO baseline using unfiltered + 2x dp100 data."""
...
DATA = ROOT / 'data' / 'c2h4_case_pairs_smoke_mixed_unfiltered_dp100x2.npy'
META = ROOT / 'data' / 'c2h4_case_pairs_smoke_mixed_unfiltered_dp100x2.json'
CKPT = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_mixed_unfiltered_dp100x2_fno_smoke.pt'
EXPORT_DIR = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_mixed_unfiltered_dp100x2_fno_smoke_deepflame_bundle'
SUMMARY = ROOT / 'artifacts' / 'experiments' / 'c2h4_casepair_mixed_unfiltered_dp100x2_fno_smoke_baseline' / 'summary.json'
DT = 1e-7
EPOCHS = 6
SEED = 0
...
def main() -> None:
    ...
    summary = {
        ...
        'seed': SEED,
        'export': export_info,
        'note': 'Weighted-mix C2H4 case-pair FNO baseline using unfiltered + 2x dp100 paired-state data.',
    }
