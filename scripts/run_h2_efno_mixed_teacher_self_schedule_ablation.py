#!/usr/bin/env python3
"""Seeded scheduled mixed teacher/self two-step ablation for EFNO on H2 holdout."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_mixed_teacher_self_schedule_ablation"
...
CASES = {
    ...
    "mixed_teacher_self_ratio0p25_linearwarmup": {
        **BASE,
        "rollout_consistency_mode": "mixed_teacher_self",
        "rollout_self_mix_ratio": 0.25,
        "rollout_self_mix_schedule": "linear_warmup",
        "rollout_feature_clip": 10.0,
        "gradient_clip_norm": 1.0,
    },
    "mixed_teacher_self_ratio0p5_linearwarmup": {
        **BASE,
        "rollout_consistency_mode": "mixed_teacher_self",
        "rollout_self_mix_ratio": 0.5,
        "rollout_self_mix_schedule": "linear_warmup",
        "rollout_feature_clip": 10.0,
        "gradient_clip_norm": 1.0,
    },
