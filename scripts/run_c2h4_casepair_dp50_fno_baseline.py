#!/usr/bin/env python3
"""Train/export the first tighter pressure-filtered C2H4 case-pair FNO baseline."""
...
DATA = ROOT / 'data' / 'c2h4_case_pairs_smoke_dp50.npy'
META = ROOT / 'data' / 'c2h4_case_pairs_smoke_dp50.json'
CKPT = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_dp50_fno_smoke.pt'
EXPORT_DIR = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_dp50_fno_smoke_deepflame_bundle'
SUMMARY = ROOT / 'artifacts' / 'experiments' / 'c2h4_casepair_dp50_fno_smoke_baseline' / 'summary.json'
DT = 1e-7
EPOCHS = 6
SEED = 0
...
def main() -> None:
    ...
    summary = {
        ...
        'seed': SEED,
        'export': export_info,
        'note': 'First tighter pressure-filtered C2H4 CFD-state-pair FNO baseline with |Δp| <= 50 Pa.',
    }
