#!/usr/bin/env python3
"""Seeded ablation of non-oracle current-state last-species features in self-rollout EFNO."""
...
EXP_DIR = ROOT / 'artifacts' / 'experiments' / 'h2_efno_self_rollout_current_last_species_ablation'
...
CASES = {
    ...
    'self_rollout0p1_current_last_species': {
        **BASE,
        'rollout_consistency_mode': 'self',
        'rollout_species_feature_mode': 'self',
        'rollout_last_species_feature_mode': 'current_state',
    },
    ...
    'self_rollout0p1_predicted_main_bct_current_last': {
        **BASE,
        'rollout_consistency_mode': 'self',
        'rollout_species_feature_mode': 'predicted_main_bct',
        'rollout_last_species_feature_mode': 'current_state',
