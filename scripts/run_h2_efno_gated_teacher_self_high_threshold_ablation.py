#!/usr/bin/env python3
"""Seeded high-threshold gated teacher/self ablation for EFNO on H2 holdout."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_gated_teacher_self_high_threshold_ablation"
...
CASES = {
    ...
    "gated_teacher_self_thr1p8": {
        **BASE,
        "rollout_consistency_mode": "gated_teacher_self",
        "rollout_self_gate_threshold": 1.8,
        "rollout_feature_clip": 10.0,
        "gradient_clip_norm": 1.0,
    },
    "gated_teacher_self_thr2p0": {
        **BASE,
        "rollout_consistency_mode": "gated_teacher_self",
        "rollout_self_gate_threshold": 2.0,
        "rollout_feature_clip": 10.0,
        "gradient_clip_norm": 1.0,
    },
    "gated_teacher_self_thr2p5": {
        **BASE,
        "rollout_consistency_mode": "gated_teacher_self",
        "rollout_self_gate_threshold": 2.5,
        "rollout_feature_clip": 10.0,
        "gradient_clip_norm": 1.0,
    },
}
