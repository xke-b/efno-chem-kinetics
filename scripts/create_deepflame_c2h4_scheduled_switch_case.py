...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--switch-bundle-dir', required=True)
    parser.add_argument('--switch-time', required=True)
    parser.add_argument('--end-time', default='5e-6')
...
def main() -> None:
    ...
    bundle_dir = Path(args.switch_bundle_dir)
