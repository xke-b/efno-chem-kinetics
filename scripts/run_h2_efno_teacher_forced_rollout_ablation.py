#!/usr/bin/env python3
"""Seeded teacher-forced two-step loss ablation for the best current EFNO MLP branch."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_teacher_forced_rollout_ablation"
...
CASES = {
    "baseline_tempw_0p1_speciesw_4p0": {
        **BASE,
        "rollout_consistency_weight": 0.0,
    },
    "teacherforced_rollout0p01_tempw_0p1_speciesw_4p0": {
        **BASE,
        "rollout_consistency_weight": 0.01,
