#!/usr/bin/env python3
"""Test a physically targeted EFNO element loss against no-conservation and current behavior."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_input_conserved_element_ablation"
...
CASES = {
    "bctdelta_no_conservation": {
        **BASE,
        "lambda_elements": 0.0,
    },
    "bctdelta_true_next_elem0p1": {
        **BASE,
        "lambda_elements": 0.1,
        "element_loss_mode": "true_next",
    },
    "bctdelta_input_conserved_elem0p1": {
        **BASE,
        "lambda_elements": 0.1,
        "element_loss_mode": "input_conserved",
    },
    "bctdelta_input_conserved_elem1p0": {
        **BASE,
        "lambda_elements": 1.0,
        "element_loss_mode": "input_conserved",
    },
