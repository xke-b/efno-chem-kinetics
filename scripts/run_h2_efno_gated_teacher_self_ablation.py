#!/usr/bin/env python3
"""Seeded gated teacher/self two-step ablation for EFNO on H2 holdout."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_gated_teacher_self_ablation"
...
CASES = {
    ...
    "gated_teacher_self_thr0p25": {
        **BASE,
        "rollout_consistency_mode": "gated_teacher_self",
        "rollout_self_gate_threshold": 0.25,
        "rollout_feature_clip": 10.0,
        "gradient_clip_norm": 1.0,
    },
    "gated_teacher_self_thr0p5": {
        **BASE,
        "rollout_consistency_mode": "gated_teacher_self",
        "rollout_self_gate_threshold": 0.5,
        "rollout_feature_clip": 10.0,
        "gradient_clip_norm": 1.0,
    },
}
