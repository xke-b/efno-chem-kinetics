#!/usr/bin/env python3
"""Seeded ablation of coherent full-species pre-normalization BCT features in self-rollout EFNO."""
...
EXP_DIR = ROOT / 'artifacts' / 'experiments' / 'h2_efno_self_rollout_predicted_full_bct_prenorm_ablation'
...
CASES = {
    ...
    'self_rollout0p1_predicted_full_bct_prenorm': {
        **BASE,
        'rollout_consistency_mode': 'self',
        'rollout_species_feature_mode': 'predicted_full_bct_prenorm',
        'rollout_last_species_feature_mode': 'self',
    },
}
