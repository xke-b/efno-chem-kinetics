#!/usr/bin/env python3
"""Seeded weight sweep for the current best EFNO MLP branch."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_bctdelta_weight_sweep_seeded"
