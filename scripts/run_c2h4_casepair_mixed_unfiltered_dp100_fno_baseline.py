#!/usr/bin/env python3
"""Train/export a mixed C2H4 case-pair FNO baseline using unfiltered + dp100 data."""
...
DATA = ROOT / 'data' / 'c2h4_case_pairs_smoke_mixed_unfiltered_dp100.npy'
META = ROOT / 'data' / 'c2h4_case_pairs_smoke_mixed_unfiltered_dp100.json'
CKPT = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_mixed_unfiltered_dp100_fno_smoke.pt'
EXPORT_DIR = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_mixed_unfiltered_dp100_fno_smoke_deepflame_bundle'
SUMMARY = ROOT / 'artifacts' / 'experiments' / 'c2h4_casepair_mixed_unfiltered_dp100_fno_smoke_baseline' / 'summary.json'
DT = 1e-7
EPOCHS = 6
SEED = 0
...
def main() -> None:
    ...
    summary = {
        ...
        'seed': SEED,
        'export': export_info,
        'note': 'Mixed C2H4 case-pair FNO baseline using concatenated unfiltered + dp100 paired-state data.',
    }
