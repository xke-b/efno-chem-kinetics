#!/usr/bin/env python3
"""Train/export a mixed C2H4 FNO baseline using dp100 plus a small canonical-augmented fraction."""
...
DATA = ROOT / 'data' / 'c2h4_case_pairs_smoke_dp100_plus_canonical_r0p1.npy'
META = ROOT / 'data' / 'c2h4_case_pairs_smoke_dp100_plus_canonical_r0p1.json'
CKPT = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_dp100_plus_canonical_r0p1_fno_smoke.pt'
EXPORT_DIR = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_dp100_plus_canonical_r0p1_fno_smoke_deepflame_bundle'
SUMMARY = ROOT / 'artifacts' / 'experiments' / 'c2h4_casepair_dp100_plus_canonical_r0p1_fno_smoke_baseline' / 'summary.json'
DT = 1e-7
EPOCHS = 6
SEED = 0
...
def main() -> None:
    ...
    summary = {
        ...
        'seed': SEED,
        'export': export_info,
        'note': 'Mixed C2H4 FNO baseline using dp100 plus a small (~0.1 relative weight) canonical augmented component.',
    }
