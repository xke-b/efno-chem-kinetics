#!/usr/bin/env python3
"""Train/export a C2H4 FNO baseline using early+late dp100 case-pair data."""
...
DATA = ROOT / 'data' / 'c2h4_case_pairs_dp100_early_plus_late.npy'
META = ROOT / 'data' / 'c2h4_case_pairs_dp100_early_plus_late.json'
CKPT = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_dp100_early_plus_late_fno_smoke.pt'
EXPORT_DIR = ROOT / 'artifacts' / 'models' / 'c2h4_casepair_dp100_early_plus_late_fno_smoke_deepflame_bundle'
SUMMARY = ROOT / 'artifacts' / 'experiments' / 'c2h4_casepair_dp100_early_plus_late_fno_smoke_baseline' / 'summary.json'
DT = 1e-7
EPOCHS = 6
SEED = 0
...
def main() -> None:
    ...
    summary = {
        ...
        'seed': SEED,
        'export': export_info,
        'note': 'C2H4 case-pair FNO baseline using early dp100 plus late dp100 paired-state data.',
    }
