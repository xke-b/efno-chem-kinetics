#!/usr/bin/env python3
"""Seeded rollout-weight ablation for corrected-decode EFNO on H2."""
...
EXP_DIR = ROOT / 'artifacts' / 'experiments' / 'h2_efno_bctdecode_rollout_weight_ablation'
...
CASES = {
    ...
    'self_rollout0p01_predicted_main_bct_bctdecode': {
        **BASE,
        'rollout_consistency_weight': 0.01,
        'rollout_consistency_mode': 'self',
