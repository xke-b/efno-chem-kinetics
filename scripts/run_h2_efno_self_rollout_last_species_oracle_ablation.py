#!/usr/bin/env python3
"""Seeded ablation of self-fed rollout training with oracle last-species feature replacement."""
...
EXP_DIR = ROOT / 'artifacts' / 'experiments' / 'h2_efno_self_rollout_last_species_oracle_ablation'
