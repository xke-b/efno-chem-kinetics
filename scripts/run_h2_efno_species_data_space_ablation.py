#!/usr/bin/env python3
"""Ablate EFNO species data-loss space under fixed seeds on the H2 temp+species holdout."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_species_data_space_ablation"
EXP_DIR.mkdir(parents=True, exist_ok=True)
EPOCHS = 25
SEEDS = [0, 1, 2]

CASES = {
    "efno_lowmass_mass_fraction": {
        "target_mode": "temperature_species",
        "temperature_loss_weight": 0.1,
        "species_loss_weight": 2.0,
        "species_data_space": "mass_fraction",
        "lambda_data": 1.0,
        "lambda_elements": 2.0,
        "lambda_mass": 0.1,
    },
    "efno_lowmass_bct_delta": {
        "target_mode": "temperature_species",
        "temperature_loss_weight": 0.1,
        "species_loss_weight": 2.0,
