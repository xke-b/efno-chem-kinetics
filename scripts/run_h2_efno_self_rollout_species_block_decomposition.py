#!/usr/bin/env python3
"""Seeded decomposition of self-rollout EFNO species second-step feature path."""
...
EXP_DIR = ROOT / 'artifacts' / 'experiments' / 'h2_efno_self_rollout_species_block_decomposition'
...
CASES = {
    ...
    'self_rollout0p1_oracle_last_species': {
        **BASE,
        'rollout_consistency_mode': 'self',
        'rollout_species_feature_mode': 'self',
        'rollout_last_species_feature_mode': 'teacher_forced',
    },
    'self_rollout0p1_oracle_main_species_only': {
        **BASE,
        'rollout_consistency_mode': 'self',
        'rollout_species_feature_mode': 'teacher_forced_main_only',
        'rollout_last_species_feature_mode': 'self',
    },
    'self_rollout0p1_oracle_species': {
        **BASE,
        'rollout_consistency_mode': 'self',
        'rollout_species_feature_mode': 'teacher_forced',
        'rollout_last_species_feature_mode': 'self',
    },
}
