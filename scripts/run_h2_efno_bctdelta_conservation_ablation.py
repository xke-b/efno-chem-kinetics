#!/usr/bin/env python3
"""Ablate conservation penalties for EFNO with BCT-delta species supervision."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_bctdelta_conservation_ablation"
...
CASES = {
    ...
    "bctdelta_elements_only": {
        **BASE,
        "lambda_elements": 2.0,
        "lambda_mass": 0.0,
    },
    "bctdelta_elements_lowmass": {
        **BASE,
        "lambda_elements": 2.0,
        "lambda_mass": 0.1,
    },
