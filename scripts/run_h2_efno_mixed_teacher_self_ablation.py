#!/usr/bin/env python3
"""Seeded mixed teacher/self two-step ablation for EFNO on H2 holdout."""
...
EXP_DIR = ROOT / "artifacts" / "experiments" / "h2_efno_mixed_teacher_self_ablation"
