#!/usr/bin/env python3
"""Seeded ablation of self-rollout EFNO with direct predicted-main-BCT second-step features."""
...
EXP_DIR = ROOT / 'artifacts' / 'experiments' / 'h2_efno_self_rollout_predicted_main_bct_ablation'
