...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item Convert additional current findings into stable manuscript figures/tables.
  \item Expand the manuscript body from a structured skeleton into a fully referenced narrative.
  \item Add one more semantics-improvement experiment or scope it explicitly as future work.
\end{enumerate}
